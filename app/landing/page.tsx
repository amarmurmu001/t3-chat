...
export const metadata = {
  title: 'Qubot - The AI Interface for Power Users',
  description: 'A minimal, keyboard-first interface for GPT-4, Claude 3.5, and Llama 3.',
};
    ...
    <div className="flex flex-col min-h-screen bg-[#0A0A0A] text-foreground selection:bg-primary/20 selection:text-primary overflow-x-hidden font-sans">
      ...
      <main className="flex-1 z-10 pt-24">
        ...
        <section className="relative px-6 py-20 md:py-32 flex flex-col items-center text-center space-y-10 max-w-5xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900 border border-zinc-800 text-sm font-medium text-zinc-400 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
          ...
          <h1 className="text-5xl md:text-8xl font-bold tracking-tight leading-[0.9] text-white animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            Chat with AI, <br />
            <span className="text-zinc-500">minus the friction.</span>
          </h1>

          <p className="text-xl md:text-2xl text-zinc-400 max-w-2xl font-light leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            Access the world's best models in a unified, uncluttered workspace designed for focus and speed.
          </p>

          <div className="flex flex-col sm:flex-row gap-5 w-full justify-center pt-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400">
          ...
          {/* Hero Image */}
          <div className="mt-24 w-full animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
